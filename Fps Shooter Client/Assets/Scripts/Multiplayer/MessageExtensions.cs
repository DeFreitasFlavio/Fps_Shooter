...
public class MessageExtension : MonoBehaviour
{
     public static class MessageExtensionsUnity
    {
        ...
        public static Message AddVector2(Message message, Vector2 value) => Add(message, value);
        ...
        public static Message Add(Message message, Vector2 value)
        {
        ...
        public static Vector2 GetVector2(Message message)
        {
        ...
        public static Message AddVector3(Message message, Vector3 value) => Add(message, value);
        ...
        public static Message Add(Message message, Vector3 value)
        {
            message.AddFloat(value.x);
            message.AddFloat(value.y);
        ...
        public static Vector3 GetVector3(Message message)
        {
        ...
        public static Message AddQuaternion(Message message, Quaternion value) => Add(message, value);
        ...
        public static Message Add(Message message, Quaternion value)
        {
            message.AddFloat(value.x);
            message.AddFloat(value.y);
            message.AddFloat(value.z);
